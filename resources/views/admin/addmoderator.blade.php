  ...
  <!-- BEGIN: Subheader -->
					...
					<div class="m-content">
						...
						<div class="m-portlet m-portlet--mobile">
							<div class="m-portlet__body">
								<form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('moderator.insert')}}">
										<div class="m-portlet__body">
		                                   {{csrf_field()}}
		                                                                                                                          @if($errors->any())
    ...
    @endif
											...
											<div class="form-group m-form__group">
												...
												<input type="text" class="form-control m-input" id="identity" name="identity">
											</div>
                                            	<div class="form-group m-form__group">
												<label for="mobile">
                                             ...
                                             <div class="form-group m-form__group">
												<label for="password">
												    ...
												    <select class="form-control m-bootstrap-select role_picker" name="role">
