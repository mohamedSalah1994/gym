  ...
  <!-- BEGIN: Subheader -->
					...
					<div class="m-content">
						...
						<div class="m-portlet m-portlet--mobile">
							<div class="m-portlet__body">
								<form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{route('trainer.insert')}}" enctype="multipart/form-data">
										<div class="m-portlet__body">
		                                   {{csrf_field()}}
		                                                                                                                          @if($errors->any())
    ...
    @endif
											...
											<div class="form-group m-form__group">
												...
												<input type="text" class="form-control m-input" id="job" name="job">
											</div>
											<div class="form-group m-form__group">
												<label for="identity">
                                            ...
                                            <div class="form-group m-form__group">
                                              ...
                                              <div class="form-group m-form__group">
												...
												<input type="text" class="form-control m-input" id="twitter" name="twitter">
											</div>
                                              <div class="form-group m-form__group">
												<label for="identity">
													{{__('admin.trainer insta')}}
												</label>
												<input type="text" class="form-control m-input" id="insta" name="insta">
											</div>
